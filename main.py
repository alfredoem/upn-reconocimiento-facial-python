from reconocer_personas import ReconocerPersonas

marcador = ReconocerPersonas()
#marcador.desde_camara()
marcador.desde_video('./videos/{}'.format('Alfredo.mp4'))
...
# cap = cv2.VideoCapture('./videos/' + person4Video)
#
